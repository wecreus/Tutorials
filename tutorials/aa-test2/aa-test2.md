...
## Details
The Application Customs Analytical Queries characterizes the usage of reporting and analysis.
...
Select **`"Gross Profits" / "Gross Revenue"`** as an Expression.
